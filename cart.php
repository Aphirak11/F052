...
<body class="container mt-4">
    ...
    <a href="index.php" class="btn btn-secondary mb-3">← กลับไปเลอื กสนิ คำ้</a> <!-- TODO: หน้ำ index -->
    <?php if (count($items) === 0): ?>
        <div class="alert alert-warning">ยังไม่มีสินค้าในตระกร้า</div> <!-- TODO: ข ้อควำมกรณีตะกร ้ำว่ำง -->
    <?php else: ?>
...
quantity -->
                        <td>
                            <a href="cart.php?remove=<?= $item['cart_id'] ?>" class="btn btn-sm btn-danger"
                                onclick="return confirm('คณุ ตอ้ งกำรลบสนิ คำ้นอี้ อกจำกตะกรำ้หรอื ไม?')">ลบ</a>
                            <!-- TODO: cart_id -->
                        </td>
                    </tr>
                <?php endforeach; ?>
